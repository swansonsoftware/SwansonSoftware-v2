...
function SlideCaptionBox() {
  ...
  function swapCaptionBoxBtnIco(btnId) {
    ...
    let captionBox = document.querySelector(".slideshow__slide-caption-box")
    if (btnId == TITLEBTNRIGHT) {
      captionBoxBtnIcon.classList.add("slideshow__slide-caption-box__button--icon-rotate-180")
      captionBoxBtnOrientation.current = TITLEBTNRIGHT
      captionBox.classList.add("slideshow__slide-caption-box--is-collapsed")
    } else {
      captionBoxBtnIcon.classList.remove("slideshow__slide-caption-box__button--icon-rotate-180")
      captionBoxBtnOrientation.current = TITLEBTNLEFT
      captionBox.classList.remove("slideshow__slide-caption-box--is-collapsed")
    }
  }
  ...
  return (
    <div className="slideshow__slide-caption-box">
      <button id="slideshow-caption-box-button" tabIndex="0" className="slideshow__slide-caption-box__button">
        ...
        <svg id="slide-caption-box-left-arrow" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.421 1.327 4.579 7.854M11.414 14.673 4.579 7.854" className="slideshow__slide-caption-box__button--icon-path" />
        </svg>
      </button>
