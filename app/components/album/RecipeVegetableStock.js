...
function VegetableStock() {
  ...
  const images = [
    ...
    { id: 4, lazy: false, src: "../../assets/images/2020s/DSC04292b-thumbnail.webp", srcset: "../../assets/images/2020s/DSC04292b-thumbnail.webp 1x, ../../assets/images/2020s/DSC04292b-672.webp 2x", sizes: "(max-width: 480px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw", width: "320", height: "180", alt: "Food mill with cooked leeks.", dataOrientation: "", dataPortraitsizes: "", captionHeading: "", caption: "Extracting juices out of cooked leeks with a food mill", dataSrcset: "320=320x180;360=360x202;393=393x221;432=432x243;608=608x342;672=672x378;768=768x432;896=896x504;960=960x540;1180=1180x664;1290=1290x726;1368=1368x769;1442=1442x811;1600=1600x900;1852=1852x1042;1920=1920x1080;2120=2120x1192;2379=2379x1338;2560=2560x1440;2796=2796x1573;2960=2960x1665;3240=3240x1822;3840=3840x2160" }
  ]
  ...
  const breadcrumbs = [
    ...
    { id: 3, toText: "Vegetable Stock", toUrl: "" }
  ]
  ...
  return (
    <Page title="Vegetable Stock Recipe">
      ...
      <div className="wrapper wrapper__article">
        ...
        <div className="album-recipe">Makes about 9 cups</div>
        ...
        <div className="row row--gutters">
          <div className="row__colspan-12">
            ...
            <div className="album-recipe__listItem">
              ...
              <span className="album-recipe__ingredient">Oz. leeks (about 8 small leeks), sliced into thin rounds and washed</span>
            </div>
            <div className="album-recipe__listItem">
          ...
          <div className="row__colspan-12">
            <div className="row__colspan-12">
              <h2 className="headline__h2 headline__h2--recipe">Washing the leeks</h2>
              <p>Cut off and discard the roots and any greens that extend beyond the round body of the leeks. Slice the round body of the leeks crosswise into rounds about 1/4-inch thick. Put the rounds in a large (4 quart) mixing bowl, then fill the bowl with water to cover the leeks by a couple of inches. Soak for 5 minutes, then stir the leeks with your hands, breaking apart the rounds so that any dirt lodged in them is released. Transfer the leeks a few at a time to a colander or another bowl of water and rinse. Transfer the rinsed leeks to the stock pot.</p>
            </div>
          </div>
        </div>
        <div className="row row--gutters">
        ...
        <div className="row row--gutters">
          ...
          <div className="row__colspan-8">
            <p>If you have one, a food mill does a great job extracting the liquid from the vegetables.</p>
          </div>
        </div>
        ...
        <div className="album-recipe">
          <ol>
            ...
            <li>Add the ingredients to the stock pot. Bring to a boil, then reduce heat to a slow simmer and simmer for 4 hours, partially covered.</li>
            <li>Off heat, strain the stock, pressing the liquid from the vegetables.</li>
            <li>Once the juices have been extracted from the vegetables, add the extracted juices to the stock and then strain the stock. Portion the stock as desired and freeze until needed.</li>
          </ol>
        </div>
      </div>
    </Page>
