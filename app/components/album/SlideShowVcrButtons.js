  ...
  return (
    <div className="slideshow__vcr-container">
      <button id="toggleplay" tabIndex={"0"} className="slideshow__vcr-container__vcr-button">
        <span id="slideshow-pause-play" className="accessibility--hidden">
          Pause Slideshow
        </span>
        <svg id="pause" className="slideshow__vcr-container--svg" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg id="play" className="slideshow__vcr-container--svg" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
          <path className="slideshow__vcr-container--svg--path" d="M13 1.625c6.272 0 11.375 5.103 11.375 11.375S19.272 24.375 13 24.375 1.625 19.272 1.625 13 6.728 1.625 13 1.625M13 0C5.82 0 0 5.82 0 13s5.82 13 13 13 13-5.82 13-13S20.18 0 13 0z" />
      ...
      <button id="prev" tabIndex={"0"} className="slideshow__vcr-container__vcr-button">
        <span className="accessibility--hidden">Previous Slide</span>
        <svg id="prevslide" className="slideshow__vcr-container--svg-dbl-stroke" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
      ...
      <button id="next" tabIndex={"0"} className="slideshow__vcr-container__vcr-button">
        <span className="accessibility--hidden">Next Slide</span>
        <svg id="nextslide" className="slideshow__vcr-container--svg-dbl-stroke" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
      ...
      <button id="fullscreen" tabIndex={"0"} className="slideshow__vcr-container__vcr-button">
        <span id="slideshow-full-screen" className="accessibility--hidden">
          Show Full Screen
        </span>
        <svg id="showFullscreen" className="slideshow__vcr-container--svg-dbl-stroke" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg id="exitFullscreen" className="slideshow__vcr-container--svg-dbl-stroke" aria-hidden="true" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
