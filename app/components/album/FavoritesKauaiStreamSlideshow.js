...
function FavoritesKauaiStreamSlideshow() {
  ...
  const breadcrumbs = [
    ...
    { id: 3, toText: "Kauai Favorites", toUrl: "/album/favorites/favorites-kauai" },
    { id: 3, toText: "Kauai Beach Villas Stream Erosion", toUrl: "" }
  ]

  return (
    <Page title="Kauai Beach Villas Stream Erosion">
      <GTag></GTag>
