...
function BlogJan2025_ResSwitching() {
  ...
  return (
    <Page title="Choosing Breakpoints for Resolution Switching of Images Part I: Ideas for Choosing Breakpoints">
      ...
      <GTag></GTag>
      <GStructuredData type="BlogPosting" datePublished="2025-03-20T08:01:24-07:00" dateModified="2026-08-07T09:29:53-07:00" headline="Choosing Breakpoints for Resolution Switching of Images Part I: Ideas for Choosing Breakpoints"></GStructuredData>
      ...
      <div className="wrapper wrapper__article" id="maincontent" tabIndex={-1}>
        ...
        <div className="headline__author">Gregory Swanson | Updated August 07, 2026</div>
        <div className="row row--gutters">
            ...
            <ul className="list--ul">
              <li className="list list--toc">
                ...
                <ul>
                  ...
                  <li className="list list--toc">
                    <HashLink smooth to="#ideasAnalysis" className="list--toc--a">
                      Analysis of Device Screen Sizes
                    </HashLink>
                  </li>
                </ul>
              </li>
          ...
          <div className="row__colspan-1"></div>
          <div className="row__colspan-10">
            <h3 className="headline__h3" id="ideasAnalysis" tabIndex={-1}>
              Choosing Breakpoints based on Analysis of Device Screen Sizes
            </h3>
            <p>
              The method I present in this blog post. Here is a test image. The width and height are printed on the test image to make it easy to see what the browser chose to download. When you select the image below, a large copy appears. The code for the large copy includes <code>srcset</code> and <code>sizes</code> attributes with values based on a set of images that accommodates the range of device screen sizes. The analysis to determine the set of images is described in Part 2.
            </p>
            <p className="note">
