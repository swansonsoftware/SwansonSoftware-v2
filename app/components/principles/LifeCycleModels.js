...
function LifecycleModels() {
  ...
  const notes = [
    ...
    { id: 6, listId: "footnote7", noteId: "#note7", text1: "NATO Software Engineering Conference 1968 [PDF, 136 pages]", text1IsLink: true, text1Link: "http://homepages.cs.ncl.ac.uk/brian.randell/NATO/nato1968.PDF", text2: "; p. 15, and Figure 6, p. 66.", text2IsLink: false, text2Link: "", text3: "", text3IsLink: false, text3Link: "" },
    ...
    { id: 8, listId: "footnote9", noteId: "#note8", text1: "DeGrace, P., and Stahl, L. H., 1990, Wicked Problems, Righteous Solutions : a Catalogue of Modern Software Engineering Paradigms. Yourdon Press; p. 69; Boehm, Barry W., 1988, A Spiral Model of Software Development and Enhancement. Computer, May: pp. 61-72 (", text1IsLink: false, text1Link: "", text2: "https://www.cse.msu.edu/~cse435/Homework/HW3/boehm.pdf [PDF, 25 pages]", text2IsLink: true, text2Link: "https://www.cse.msu.edu/~cse435/Homework/HW3/boehm.pdf", text3: "), p. 63; Larman, Craig & Basili, Victor R. “Iterative and Incremental Development: A Brief History.” Computer, IEEE, June 2003: pp. 47-56, p. 47, 48, and 52.", text3IsLink: false, text3Link: "" },
    ...
    { id: 15, listId: "footnote16", noteId: "#note14", text1: "Larman & Basili, 2003 [PDF 10 pages]", text1IsLink: true, text1Link: "https://www.cs.hmc.edu/courses/2004/fall/cs121/papers/larman.pdf", text2: ", p. 47 and 48.", text2IsLink: false, text2Link: "", text3: "", text3IsLink: false, text3Link: "" },
