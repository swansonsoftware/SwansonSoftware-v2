...
function LifecycleModels() {
  ...
  const notes = [
    ...
    { id: 8, listId: "footnote9", noteId: "#note8", text1: "DeGrace, P., and Stahl, L. H., 1990, Wicked Problems, Righteous Solutions : a Catalogue of Modern Software Engineering Paradigms. Yourdon Press; p. 69; Boehm, Barry W., 1988, ", text1IsLink: false, text1Link: "", text2: "A Spiral Model of Software Development and Enhancement [PDF, 25 pages]", text2IsLink: true, text2Link: "https://www.cse.msu.edu/~cse435/Homework/HW3/boehm.pdf", text3: ". Computer, May: pp. 61-72, p. 63; Larman, Craig & Basili, Victor R. ", text3IsLink: false, text3Link: "", text4: "Iterative and Incremental Development: A Brief History. [PDF 10 pages]", text4IsLink: true, text4Link: "https://www.cs.hmc.edu/courses/2004/fall/cs121/papers/larman.pdf", text5: " Computer, IEEE, June 2003: pp. 47-56, p. 47, 48, and 52.", text5IsLink: false, text5Link: "" },
